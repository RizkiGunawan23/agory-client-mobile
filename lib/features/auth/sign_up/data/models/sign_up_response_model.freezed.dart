...
bool operator ==(Object other) {
  final _this = this as SignUpResponseModel;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignUpResponseModel&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.email, _this.email) || other.email == _this.email));
}
...
String toString() {
  final _this = this as SignUpResponseModel;
  return 'SignUpResponseModel(id: ${_this.id}, email: ${_this.email})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,}) {
  return _then(SignUpResponseModel(
...
class _SignUpResponseModel implements SignUpResponseModel {
  const _SignUpResponseModel({required this.id, required this.email});
...
@override
bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignUpResponseModel&&(identical(other.id, id) || other.id == id)&&(identical(other.email, email) || other.email == email));
}
...
@override
String toString() {
    return 'SignUpResponseModel(id: $id, email: $email)';
}
