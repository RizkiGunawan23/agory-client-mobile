...
bool operator ==(Object other) {
  final _this = this as SignInRequestModel;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignInRequestModel&&(identical(other.email, _this.email) || other.email == _this.email)&&(identical(other.password, _this.password) || other.password == _this.password));
}
...
String toString() {
  final _this = this as SignInRequestModel;
  return 'SignInRequestModel(email: ${_this.email}, password: ${_this.password})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? email = null,Object? password = null,}) {
  return _then(SignInRequestModel(
