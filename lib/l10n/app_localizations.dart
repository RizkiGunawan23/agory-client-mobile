...
abstract class AppLocalizations {
  ...
  /// Nama aplikasi, ditampilkan sebagai judul window/tab
  ///
  /// In id, this message translates to:
  /// **'Agory'**
  String get appTitle;

  /// Judul AppBar di halaman sign up
  ///
  /// In id, this message translates to:
  /// **'Daftar Akun'**
  String get signUpScreenTitle;

  /// Label field input email
  ///
  /// In id, this message translates to:
  /// **'Email'**
  String get emailFieldLabel;

  /// Label field input password
  ///
  /// In id, this message translates to:
  /// **'Password'**
  String get passwordFieldLabel;

  /// Label tombol submit sign up
  ///
  /// In id, this message translates to:
  /// **'Daftar'**
  String get signUpButtonLabel;

  /// Pesan snackbar ketika sign up berhasil
  ///
  /// In id, this message translates to:
  /// **'Sign up berhasil!'**
  String get signUpSuccessMessage;

  /// Pesan error fallback ketika penyebab error tidak diketahui
  ///
  /// In id, this message translates to:
  /// **'Terjadi kesalahan'**
  String get genericErrorMessage;

  /// Validasi ketika field email kosong
  ///
  /// In id, this message translates to:
  /// **'Email wajib diisi'**
  String get emailRequiredError;

  /// Validasi ketika format email salah
  ///
  /// In id, this message translates to:
  /// **'Format email tidak valid'**
  String get emailInvalidError;

  /// Validasi ketika field password kosong
  ///
  /// In id, this message translates to:
